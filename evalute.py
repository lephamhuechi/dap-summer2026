"""
evaluate.py — E-commerce Dynamic Pricing
Mục đích: So sánh fixed vs dynamic pricing, đánh giá model, kết luận business

Chạy: python evaluate.py
      python evaluate.py --model model.pkl   (nếu đã train model)
Output: charts/07_fixed_vs_dynamic.png
        charts/08_revenue_lift_by_category.png
